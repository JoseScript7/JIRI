...
// Note: Fill Game mostly reuses the existing POST /api/round/start and /api/round/:id/answer
// but we add this endpoint to log the overall mini-game session to game_results.
